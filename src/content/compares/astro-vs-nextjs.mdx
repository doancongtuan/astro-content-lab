...
category: deep-dive
tags: ["astro", "nextjs", "comparison", "javascript"]
---
...
<ComparisonTable
  ...
  rightLabel="Next.js"
  factors={[
    { label: "Default JavaScript shipped", left: "Zero", right: "React runtime", winner: "left" },
    { label: "Static generation", left: "Yes, default", right: "Yes, opt-in", winner: "tie" },
    { label: "Server-side rendering", left: "Yes, opt-in", right: "Yes, built-in", winner: "tie" },
    { label: "Content Collections", left: "Built-in", right: "Manual setup", winner: "left" },
    { label: "Learning curve", left: "Gentle", right: "Steeper (requires React)", winner: "left" },
    { label: "Best for", left: "Content sites", right: "Web applications", winner: "tie" },
    { label: "E-commerce", left: "Limited", right: "Excellent with React ecosystem", winner: "right" },
  ]}
/>
